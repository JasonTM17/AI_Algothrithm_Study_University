...
ALGORITHM_GROUPS = {
    ...
    "CSP": ["Backtracking", "Backtracking + Forward Checking", "AC-3",
            "Min-Conflicts"],
...
THEORY_KEY_MAP = {
    ...
    "Backtracking + Forward Checking": "Backtracking + Forward Checking",
    "AC-3": "AC-3",
...
COMPARISON_TABLE = [
    ...
    {"Group": "Complex", "Algorithm": "Searching with no observation", "Complete": "Bounded", "Optimal": "No", "Heuristic": "Belief state", "Random": "Seeded belief", "Suitable": "Conformant planning"},
    {"Group": "Complex", "Algorithm": "Searching for partially observable problems", "Complete": "Bounded", "Optimal": "No", "Heuristic": "Belief state", "Random": "Seeded belief", "Suitable": "Contingent policy"},
    {"Group": "CSP", "Algorithm": "Backtracking", "Complete": "Bounded", "Optimal": "No", "Heuristic": "No", "Random": "No", "Suitable": "Exact-horizon CSP"},
    {"Group": "CSP", "Algorithm": "Backtracking + Forward Checking", "Complete": "Bounded", "Optimal": "No", "Heuristic": "No", "Random": "No", "Suitable": "Pruned CSP search"},
    {"Group": "CSP", "Algorithm": "AC-3", "Complete": "Propagation", "Optimal": "-", "Heuristic": "No", "Random": "No", "Suitable": "Arc consistency"},
    {"Group": "CSP", "Algorithm": "Min-Conflicts", "Complete": "No", "Optimal": "No", "Heuristic": "Conflicts", "Random": "Yes", "Suitable": "Bounded CSP repair"},
