...
SYLLABUS_COVERAGE_ROWS = [
    ...
    },
    {
        ...
        "App surface": "Advanced -> CSP Workbench",
    ...
    },
    {
        ...
        "App surface": "Advanced -> CSP Workbench -> AC-3",
    ...
    },
    {
        ...
        "App surface": "Theory/PEAS -> CSP concepts",
    ...
    },
    {
        ...
        "App surface": "Advanced -> CSP Workbench -> Backtracking",
        "Evidence": "Chronological assignment over the bounded state-chain CSP.",
        "Defense note": "A horizon failure is not a proof of global unsolvability.",
    },
    {
        "Syllabus topic": "Min-conflicts algorithm",
        "App surface": "Advanced -> CSP Workbench -> Min-Conflicts",
        "Evidence": "Seeded repair of a complete state-chain assignment; replay only at zero conflict.",
        "Defense note": "Iteration failure proves neither impossibility nor optimality.",
    },
    {
