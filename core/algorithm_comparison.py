...
ALGORITHM_COMPARISON_ROWS = [
    ...
    _row("Complex Environments", "No Observation Search", "Minimize average belief h", "O(SAB)", "O(B)", "Action sequence over belief", "Model evidence, not standard optimal path"),
    _row("Complex Environments", "Partially Observable Search", "Belief action + observation filter", "O(SAB)", "O(B)", "Actual path plus observations", "Sensor-model demonstration"),
